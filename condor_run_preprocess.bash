...
INPUTFILE=/net/data_ttk/hreyes/JetClass/JetClass_pt_part/JetClass_pt_part/HToCC_train.h5
OUTPUTDIR=${HOME}/Documents/master_thesis/hep_foundation_model/processed_data
...
python ${PROGRAM} --input_file ${INPUTFILE} --output_file ${OUTPUTFILE} --n_jets 1000000 2>&1 >> ${LOGFILE}
